...
\x1b[1;90m  ____  _        _    ____ _  __  _____ _____    _    __  __ 
\x1b[1;90m | __ )| |      / \  / ___| |/ / |_   _| ____|  / \  |  \/  |
\x1b[1;90m |  _ \| |     / _ \| |   | ' /    | | |  _|   / _ \ | |\/| |
\x1b[1;90m | |_) | |___ / ___ \ |___| . \    | | | |___ / ___ \| |  | |
\x1b[1;90m |____/|_____/_/   \_\____|_|\_\   |_| |_____/_/   \_\_|  |_|
                                                             


\033[1;90m༄BLACK.᭄\x1b[1;90m════════════════════════════════════════════\x1b[1;90m༄TEAM᭄
\033[1;90m༄BLACK.᭄\x1b[1;90m════════════════════════════════════════════\x1b[1;90m༄TEAM᭄
           \x1b[1;92m╔═════════════════════════════╗
           \x1b[1;92m║ TOOL NAME : { Dec"Enc }   ║
           \x1b[1;92m║ AUTHOR    : BLACK.TEAM      ║
           \x1b[1;92m║ GITHUB    : git.me/AfghanHack001 ║
           \x1b[1;92m║ FACEBOOK  : Nadarom🥴   ║
           \x1b[1;92m║ Group     : BLACK ║
...
def ige():
    ...
    os.system("xdg-open https://www.facebook.com/edris.malik.5")
    time.sleep(7)
    input("\n [BACK]")
    main()           
...
#def about():
    ...
    print(logo)
    print(yellow+'╔═══════════════════════════════════════════════╗')
    print(yellow+'║'+cyan+'[ Tools ]     '+purple+' :'+green+'Emoji-Encrypt                      '+yellow+'   ║')              
    print(yellow+'║'+cyan+'[ Version ]   '+purple+' :'+green+'[2.0]                       '+yellow+'   ║')
    print(yellow+'║'+cyan+'[ Author ]    '+purple+' :[BlackTeam] ')
    print(yellow+'║'+cyan+'[ Github ]    '+purple+' :[https://github.com/AfghanHack001] ')
    print(cyan+'║[Messenger] '+purple+' :[https://m.me/edris.malik.5]')
    print(cyan+'║[Email]     '+purple+' :[********@gmail.com]\n')
    print('\n[01] Main Menu')
    print('[02] Exit')
...
def encryptvar():
    ...
    with open(in_file, 'r', encoding='utf-8', errors='ignore') as in_f,open(out_file, 'w') as out_f:
       ...
       out_f.write("# Encrypted by BlackTeam\n# Whatsapp *********** \n# Github- https://github.com/BlackTeam\n\n"+obfuscated_content)
    sprint(success + out_file + " saved in "+pwd)
    mover(out_file)
...
def main():
    ...
    print(yellow+'║'+green+' ['+white+'4'+green+']'+yellow+' Encrypt-Emoji'+cyan+' Python into emoji')
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system('xdg-open --view https://www.facebook.com/MrK4US4R')
                ret=input(white+"\nENTER TO BACK > "+green)
            main()    
   #         else:
    #   os.system('xdg-open https://www.facebook.com/edris.malik.5 ')
