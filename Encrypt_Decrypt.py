...
def banner_dec():
    banner = ('\x1b[1;90m:::    :::     :::     :::    :::  ::::::::      :::     :::::::::  \n\x1b[1;90m:+:   :+:    :+: :+:   :+:    :+: :+:    :+:   :+: :+:   :+:    :+: \n\x1b[1;90m+:+  +:+    +:+   +:+  +:+    +:+ +:+         +:+   +:+  +:+    +:+ \n\x1b[1;90m+#++:++    +#++:++#++: +#+    +:+ +#++:++#++ +#++:++#++: +#++:++#:  \n\x1b[1;90m+#+  +#+   +#+     +#+ +#+    +#+        +#+ +#+     +#+ +#+    +#+ \n\x1b[1;90m#+#   #+#  #+#     #+# #+#    #+# #+#    #+# #+#     #+# #+#    #+# \n\x1b[1;90m###    ### ###     ###  ########   ########  ###     ### ###    ### \n\x1b[1;90m-----------------------------------------------  \n\x1b[1;92mFROM : AFGHANSTAN,MAZAR\n\x1b[1;32m(*) AUTHOR NAME :\x1b[1;92mBlackTeam\n\x1b[1;92m(*)WHATSAPP NO : **************\x1a\x1a\n\x1b[1;92m(*) FACEBOOK ID : edris.malik.5\n\x1b[1;92m(*) WARNING : STAY HOME STAY SAVE\n\x1b[1;37m-----------------------------------------------').format(m, p)
    running(banner)


def banner_enc():
    banner = ('\n\n\n\x1b[1;90m:::    :::     :::     :::    :::  ::::::::      :::     :::::::::  \n\x1b[1;90m:+:   :+:    :+: :+:   :+:    :+: :+:    :+:   :+: :+:   :+:    :+: \n\x1b[1;90m+:+  +:+    +:+   +:+  +:+    +:+ +:+         +:+   +:+  +:+    +:+ \n\x1b[1;90m+#++:++    +#++:++#++: +#+    +:+ +#++:++#++ +#++:++#++: +#++:++#:  \n\x1b[1;90m+#+  +#+   +#+     +#+ +#+    +#+        +#+ +#+     +#+ +#+    +#+ \n\x1b[1;90m#+#   #+#  #+#     #+# #+#    #+# #+#    #+# #+#     #+# #+#    #+# \n\x1b[1;90m###    ### ###     ###  ########   ########  ###     ### ###    ###\n\x1b[1;95m-----------------------------------------------  \n\x1b[1;92mFROM : AFGHANSTAN,MAZAR\n\x1b[1;32m(*) AUTHOR NAME :\x1b[1;92mBlackTeam\n\x1b[1;92m(*)WHATSAPP NO : ************\x1a\x1a\n\x1b[1;93m(*) FACEBOOK ID : edris.malik.5\n\x1b[1;96m(*) WARNING : STAY HOME STAY SAVE\n\x1b[1;37m-----------------------------------------------      \n                                          \n                                          \n    \n').format(m)
    running(banner)
...
def menu():
    ...
    if fuck == '1' or fuck == '01':
        ...
        try:
            sp.check_output([
             'am', 'start',
             'https://api.whatsapp.com/send?phone=+01612278337&text=Report : ' + chat + ''])
        except:
